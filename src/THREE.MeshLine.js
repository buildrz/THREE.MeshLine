...
THREE.ShaderChunk[ 'meshline_vert' ] = [
	...
	'		if (projectionMatrix[3][3] == 0.) {//perspective',
	'    		float pixelWidthRatio = 1. / (resolution.x * projectionMatrix[0][0]);',
	'			w *= finalPosition.w * pixelWidthRatio;',
	'		}',
	'		else {//orthographic',
	'			//this value is completely empirical and may only work in some situations,',
	'			//the mathematically correct way would use planes/projection matrix',
	'			w *= 0.002 ;',
	'		}',
	'    }',
	'',
